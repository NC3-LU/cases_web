...
<h3 class="titre-page" id="wifi-for-employees">Wifi for employees</h3>
...
<h3 class="titre-page" id="wifi-for-visitors-external-users">Wifi for visitors/external users</h3>
