...
toc: true
---
<h3 class="titre-page" id="why-try-out-a-web-browser-in-a-protected-space-?">Why try out a web browser in a protected space?</h3>
...
<h3 class="titre-page" id="first-steps-with-sandboxie">First steps with Sandboxie</h3>
...
<h3 class="titre-page" id="final-observations">Final observations</h3>
