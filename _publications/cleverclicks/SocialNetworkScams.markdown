...
<h3 class="titre-page" id="cloned-profile">Cloned profile</h3>
...
<h3 class="titre-page" id="pirated-profile">Pirated profile</h3>
...
<h3 class="titre-page" id="fake-facebook-emails">Fake Facebook emails</h3>
...
<h3 class="titre-page" id="fake-quizzes-gift-vouchers-and-free-offers">Fake quizzes, gift vouchers and free offers</h3>
...
<h3 class="titre-page" id="links-camouflaged-in-videosstatuses">Links camouflaged in videos/statuses</h3>
...
<h3 class="titre-page" id="infected-statuses">Infected statuses</h3>
...
<h3 class="titre-page" id="fake-fan-pages">Fake fan pages</h3>
...
<h3 class="titre-page" id="third-part-applications">Third-party applications</h3>
