...
[Social Engineering]({% link _knowhow/glossary/SocialEngineering.markdown %}) is manipulation by deception. We come across social engineering in our everyday lives, e.g. in advertisements, on dating sites or during job interviews. In these specific cases, the 'canvasser' tries to behave or sell him or herself to achieve his or her objective.
