...
<h3 class="titre-page" id="making-a-complaint">Making a complaint</h3>
...
<h3 class="titre-page" id="drafting-a-complaint">Drafting a complaint</h3>
The complaint must:
...
<h3 class="titre-page" id="civil-action">Civil action</h3>
...
<h3 class="titre-page" id="private-prosecution">Private prosecution</h3>
