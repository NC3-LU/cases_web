...
Regardless of the strategy chosen, it is always of benefit to identify “quick wins” (such as [update management]({{ site.url }}/knowhow/glossary/Patches.html), [encrypted wifi networks]({{ site.url }}/publications/recommendationsecuring/SecuringWifiNetwork.html), [password management]({{ site.url }}/knowhow/glossary/Password.html), etc.) that can be set up rapidly. These guarantee immediate results and are often suitable to resolve certain urgent issues or to persuade the management of the importance of security issues.
...
To protect essential working tools, implement preventive and protective measures for your [computers]({{ site.url }}/publications/ProtectingYourCompany.html#computers), [laptops]({{ site.url }}/publications/ProtectingYourCompany.html#laptop-computer), [file server]({{ site.url }}/publications/ProtectingYourCompany.html#file-servers), [mail server]({{ site.url }}/publications/ProtectingYourCompany.html#email-servers) and [web server]({{ site.url }}/publications/ProtectingYourCompany.html#web-server). Implement “incident response” type measures.

<h3 class="titre-page">Protecting the network</h3>
You should also consider protecting your network, whether it is a [fixed]({{ site.url }}/publications/ProtectingYourCompany.html#local-fixed-network) or [wifi network]({{ site.url }}/publications/ProtectingYourCompany.html#wifi-network). Implement the necessary measures.

<h3 class="titre-page">Awareness and training</h3>
Make sure you raise [awareness and train]({{ site.url }}/publications/ProtectingYourCompany.html#training-and-awareness) all your employees about IT security. The adoption of proper behavioural practices by all staff is an extremely important measure. This often entails deploying greater efforts at organisational and behavioural level and also at technical level, to increase your data security most effectively.
...
* [Threats]({{site.url}}/knowhow/bestpractices/SecurityMeasures4SME-Threats2Infrastructure.html) to infrastructure
...
* [Threats]({{site.url}}/knowhow/bestpractices/SecurityMeasures4SME-Threats2Hardware.html) to hardware
...
* [Threats]({{site.url}}/knowhow/bestpractices/SecurityMeasures4SME-Threats2Software.html) to software
...
* [Threats]({{site.url}}/knowhow/bestpractices/SecurityMeasures4SME-Threats2HR.html) to people
