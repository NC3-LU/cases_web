...
<h3 class="titre-page" id="reproduction-of-protected-works-and-photographs">Reproduction of protected works and photographs</h3>
...
<h3 class="titre-page" id="sharing-files-over-the-internet">Sharing files over the Internet</h3>
...
<h3 class="titre-page" id="trademark-protection">Trademark protection</h3>
