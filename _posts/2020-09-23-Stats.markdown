...
The below line graph shows the above figures in a visual manner. The horizontal axis represents the period of 2016-2019, whereas the vertical axis shows the values of 3 important cybersecurity threats in percentages of the Dangerousness Indicator. 
